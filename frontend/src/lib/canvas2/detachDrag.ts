 ...
 *
 * 220 → 560 → 380. 220은 "잘 안 걸린다", 560은 "너무 세다"(사용자 2026-08-05
 * → 08-06). 카드 폭(560)의 3분의 2쯤이면 가져다 대려는 의도는 잡히면서
 * 지나가던 카드까지 끌려오지는 않는다.
 */
export const MAGNET_DIST = 380;
 ...
 *
 * 96 → 240 → 150. "근처로 가면 바로 붙어야 한다"와 "너무 세다" 사이다
 * (사용자 2026-08-05 → 08-06). 자석 반경의 절반 아래로 두어 끌리는 구간은
 * 남긴다 — 붙는 순간이 사건으로 읽히려면 그 구간이 있어야 한다.
 */
